...
test.describe("Feature: Log in", () => {
  ...
  test('On every page of the site, a Profile button must be at the top-right of the page.  It should have have the attribute: data-testid="user-menu-button"', async ({
    page,
  }) => {
